...
public class DriveTrain {
    private final SwervePiece frontRight = new SwervePiece(3, 4, 0);
    private final SwervePiece frontLeft = new SwervePiece(5, 6, 1);
    private final SwervePiece backLeft = new SwervePiece(7, 8, 2);
    private final SwervePiece backRight = new SwervePiece(9, 10, 3);
     ...
     */
    public void drive(double xPull, double yPull, double zPull, boolean slow) {
